...
class App extends Component {
  render() {
    //如果是数值不用加单位 如果是联合单词则需要第二个单词首字母大写
...
1. React看似没有使用，为什么要引入进来?

jsx代码在执行之前会转换成`react.createElement`方法，在执行的时候需要去找react.createElement 方法 不引入就找不到了 
...
不要再constructor中使用副作用操作，例如发起ajax请求
...
```
  ...
  [1]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/242305220.png
  [2]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/578516176.gif
  [3]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/2193484749.png
  [4]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/2117606782.png
  [5]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/800611024.jpg
  [6]: https://typecho.heart.xn--6qq986b3xl/usr/uploads/2021/04/3177549991.png